  ...
  <header id="header" class="navigation fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="/<?php echo $salesRef ?>#hero"><?php echo $menuHome ?></a></li>
          <li><a href="/<?php echo $salesRef ?>#about"><?php echo $menuAbout ?></a></li>
...
<?php endforeach ?>
          ...
          <li><a href="/<?php echo $salesRef ?>#coverage"><?php echo $menuShipping ?></a></li>
        </ul>
      </nav>
      <div class="d-flex align-items-center gap-3">
        <a class="btn-book-a-table" href="/<?php echo $salesRef ?>#contacto"><?php echo $menuContact ?></a>
      </div>
