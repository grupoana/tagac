...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      <a href="/<?php echo $salesRef ?>" class="logo d-flex align-items-center me-auto me-lg-0">
        <img src="https://www.tagac.com.mx/assets/img/tagac-logo.png" class="img-fluid" alt="">
      </a>
  ...
  <main id="main">
    ...
    <!-- ======= New Section ======= -->
    <section id="packing">
      <div class="container-fluid d-flex flex-column jusitfy-content-center align-items-center" data-aos="fade-up">
        ...
        <div id="carrusel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
              ...
              foreach ($imagenes as $index => $imagen) {
                  ...
                  echo '<img src="' . $imagen . '" class="d-block w-100" alt="Empaque">';
                  echo '</div>';
              }
              ?>
          </div>
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="row">
            <img src="https://www.tagac.com.mx/<?php echo $shipImg[$lang] ?>" class="col-lg-8"
              alt="<?php echo $shipImgAlt[$lang] ?>" style="width: 500px;">
